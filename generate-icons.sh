...
# Script to generate all the icons for the Video Converter PWA

echo "Generating icons for the Video Converter PWA..."
...
cat > www/manifest.json << EOF
{
  ...
  "short_name": "VideoConverter",
  "start_url": "./index.html",
  "display": "standalone",
  "theme_color": "#3498db",
  "background_color": "#f5f7fa",
  "description": "A web-based video converter using FFmpeg.wasm.",
  "icons": [
    {
